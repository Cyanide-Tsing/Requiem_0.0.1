ServerEvents.recipes(event=>{
    ...
    //event.remove({id:"kubejs:silicon"})
    ...
    event.recipes.vintageimprovements.pressurizing(["kubejs:silicon", Fluid.of("kubejs:hydrochloric_acid", 1000)], [Fluid.of('kubejs:silicon_tetrachloride', 250), Fluid.of('ad_astra:hydrogen', 500)]).secondaryFluidInput(1).heated().id("requiem:pressurizing/pure_silicon")

    //Oxidizing Silicon
    event.blasting("minecraft:quartz", "kubejs:silicon").id("requiem:blasting/quartz_from_pure_silicon")
