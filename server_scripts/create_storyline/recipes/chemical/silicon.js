ServerEvents.recipes(event=>{
    ...
    event.recipes.vintageimprovements.pressurizing([Fluid.of("kubejs:silicon_tetrachloride", 250), Fluid.of("kubejs:carbon_dioxide", 250)], [Fluid.of("kubejs:molten_quartz", 100), '#minecraft:coals', Fluid.of("kubejs:chlorine", 500)]).secondaryFluidInput(0).id("requiem:pressurizing/silicon_tetrachloride_from_molten_quartz")
